		...
		createUploadImage : function(fieldid, width, height , _initpic_  , funcallback, strictlen, maxlen, strictsize, maxsize){
			...
			// 创建按钮
  			el.uploadify({
  			      ...
  			      uploader      : '/fileupload?fn=' + uploadFileName + "&fid=" + buttonClassName + "&strictSize=" + _strictsize_ +"&maxsize=" +  _maxsize_ + "&strictLength=" + _strictlen_ + "&maxlen=" + _maxlen_,
  			      ...
  			      'onUploadSuccess': function(file , data, response){
  				      	...
  				      	if (jsonobj.success === true) {
  				      		$("." + jsonobj.msg.fid).css("background-image" , "url('" + jsonobj.msg.url + "')");
