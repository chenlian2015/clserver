...
<@compress>
<#if front=='1'><link type="text/css" rel="stylesheet" href="${static_server}/themes/greencube/css/style${js_and_css_compress_extention}.css" /></#if>
<#if instadmin=='1'><link type="text/css" rel="stylesheet" href="${static_server}/themes/greencube/css/style${js_and_css_compress_extention}.css" /></#if>
<#if ucenter=='1'><link type="text/css" rel="stylesheet" href="${static_server}/themes/greencube/css/style${js_and_css_compress_extention}.css" /></#if>
</@compress>
</#macro>
...
<#if global=='1'>
	<script type="text/javascript" src="${static_server}/script/greencube/global${js_and_css_compress_extention}.js" ></script>
	<script type="text/javascript" src="${static_server}/script/greencube/topacc${js_and_css_compress_extention}.js"></script>
</#if>
<#if formValidation=='1'>
</#if>
...
<#if myjs=='1'>
	<script type="text/javascript" src="${static_server}/script/greencube/myjs.js"></script>
</#if>
<#if html5=='1'>
	<!--[if IE]>
