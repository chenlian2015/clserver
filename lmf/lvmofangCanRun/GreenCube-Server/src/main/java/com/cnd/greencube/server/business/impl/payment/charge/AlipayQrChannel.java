 ...
 * 
 */
public class AlipayQrChannel extends AbstractChannel implements IChannel {
	public AlipayQrChannel(String indefier, String paymentId, int amoun, String clientIp, String subject, String body, String description) {
