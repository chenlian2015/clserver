...
public class PageTag extends BodyTagSupport {
	...
	public int doStartTag() throws JspException {
		if (useSkin) {
			...
			sb.append("<script src=\"").append(SysConfiguration.getProperty("system.static_server") + "/script/cnd.js\" type=\"text/javascript\"></script>");
			sb.append("<script src=\"").append(SysConfiguration.getProperty("system.static_server") + "/script/cnd.admin.js\" type=\"text/javascript\"></script>");
			sb.append("");
	...
	public int doEndTag() throws JspException {
		...
		sb.append("	<script src=\"" + SysConfiguration.getProperty("system.static_server") + "/themes/metro/js/app.js\" type=\"text/javascript\"></script>");
		sb.append("");
		sb.append("	<script>");
