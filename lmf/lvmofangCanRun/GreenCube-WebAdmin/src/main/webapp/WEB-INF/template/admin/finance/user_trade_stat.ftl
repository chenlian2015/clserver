...
[@ui.page]
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				<!-- 页面头部定义-->
				<h3 class="page-title">注册用户交易统计</h3>
							...
							<table class="table table-striped table-bordered table-hover" id="sample_3">
								...
								<tbody>
										<tr class="odd gradeX">
											...
											<td>1000</td>
											<td>
											<a href="/admin/finance/user_trade_detail?memberId=${m['id']}" class="btn green  mini" data-id="${m['id']}" data-value="1"><i class="icon-leaf"></i> 条目</a>
											</td>
										</tr>
										<tr class="odd gradeX">
											<td>2016-02</td>
