...
[@ui.page]
	...
	<div class="container-fluid">
		...
		<div class="row-fluid">
			<div class="span12">
				<!-- 页面头部定义-->
				<h3 class="page-title">供产会会员申请列表</h3>
	
				<ul class="breadcrumb">
					<li>
						<i class="icon-home"></i>待审核的供产会用户
					</li>
								...
								<tbody>
									[#list members as m]
										<tr class="odd gradeX">
											...
											<td>${m["providerPhone"] }</td>
											<td nowrap>
											    <a href="/admin/member/provider_applied_detail?memberId=${m['id']}" class="btn yellow btnDetail mini" data-id="${m['id']}" data-value="1"><i class="icon-leaf"></i> 详情</a>
