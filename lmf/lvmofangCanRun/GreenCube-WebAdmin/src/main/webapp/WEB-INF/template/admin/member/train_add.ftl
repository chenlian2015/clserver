				...
				<div class="span12">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							<div class="caption">
								<i class="icon-reorder"></i><span class="hidden-480">添加试卷</span>
							</div>
						</div>
						<div class="portlet-body form">
							<form id="addform" class="form-horizontal">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_3">
									<tbody>
										<tr>
											<td width="150">试卷名称：</td>
											<td>
												<input type="text" class="validate[required]" name="name" placeholder="请填写试卷名称">
											</td>
											<td></td>
										</tr>
										<tr>
											<td width="150">试卷类型</td>
											<td>
											  <input type="radio" name="composeMethod" value="0" checked>普通组卷
											  <input type="radio" name="composeMethod" value="1">智能组卷
											</td>
											<td></td>
										</tr>
										<tr class="odd gradeX">
