									...
									[#list orderprolist as o]
										<tr class="odd gradeX">
											...
											<td>[#if o.NStatus ==0 ]
												...
												[/#if]</td>
											<td nowrap>
												<a href="javascript:void(0);" data-id="${o.id }" class="btn green mini"><i class="icon-edit"></i>发货</a> 
...
<script>	
	$(document).ready(function(){
		...
		$(".btn").on("click",function(){
			...
			Submit.invok("/admin/order/order_deliver?orderId="
					+ cid, function() {
				window.location.reload("/admin/order/order_processed_list");
				alert("发货成功！");
			});
		});
