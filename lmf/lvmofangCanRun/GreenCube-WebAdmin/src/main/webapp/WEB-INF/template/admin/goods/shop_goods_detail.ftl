	...
	#reviewback{
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
				<div>
					<h3 class="page-title">店主会商品明细</h3>
					<ul class="breadcrumb">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-reorder"></i>店主会商品详细信息</div>
							<div class="tools">
						...
						<form id="addform" class="form-horizontal">
							<div class="form-horizontal form-view">
								<h3 class="form-section">店主会商品基本信息</h3>
								...
								<div class="row-fluid">
									<div class="span6 ">
										<div class="control-group">
											...
											<div class="controls">
												<span class="text">${baseinfo.shopId }</span>
											</div>
										</div>
									</div>
									<div class="span6 ">
										<div class="control-group">
											<label class="control-label" for="lastName">店铺名称:</label>
											<div class="controls">
												<span class="text">${baseinfo.shopName }</span>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row-fluid">
									...
									<div class="span6 ">
										<div class="control-group">
											...
											<div class="controls">
												<span class="text bold">${baseinfo.order }</span>
											</div>
										</div>
									</div>
								</div>
