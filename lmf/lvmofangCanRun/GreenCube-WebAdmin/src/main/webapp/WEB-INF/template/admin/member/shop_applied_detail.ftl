	...
	#reviewback{
		...
		<div class="container-fluid">
			<div class="row-fluid">
				<div class="span12">
				<div>
					<h3 class="page-title">店主会会员明细</h3>
					<ul class="breadcrumb">
					...
					<div class="portlet box blue">
						<div class="portlet-title">
							<div class="caption"><i class="icon-reorder"></i>店主会会员详细信息</div>
							<div class="tools">
						...
						<form id="addform" class="form-horizontal">
							<div class="form-horizontal form-view">
								<h3 class="form-section">店主会会员基本信息</h3>
								
								<div class="row-fluid">
									<div class="span6 ">
										<div class="control-group">
											<label class="control-label" for="firstName">店主会名称:</label>
											<div class="controls">
							...
							<div class="form-horizontal form-view">
								<h3 class="form-section">店主会会员隐私信息</h3>
