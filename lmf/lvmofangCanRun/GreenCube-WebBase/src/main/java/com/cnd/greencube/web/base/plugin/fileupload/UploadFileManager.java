...
import com.cnd.greencube.web.base.plugin.fileupload.local.LocaldFileUploador;
import com.cnd.greencube.web.base.plugin.fileupload.samba.SambFileUploador;
...
public abstract class UploadFileManager {
	public static final String S_VIDEO_TYPE = "avi|mpg|wmv|3gp|mov|mp4|asf|asx|flv|wmv9|rm|rmvb";
	public static final String S_PIC_TYPE = "jpg|jpeg|png|gif";
	public static final String S_DOC_TYPE = "txt|doc|docx|ppt|pptx|pdf|xls|xlsx";
	...
	public static final String URL_VIDEO_NOIMAGE = SysConfiguration.getInstance().getProperty("CFG_URL_O_FS") + "/public/images/no_image.jpg";
	public static final String URL_DOC_NOIMAGE = SysConfiguration.getInstance().getProperty("CFG_URL_O_FS") + "/public/images/no_doc_image.jpg";
