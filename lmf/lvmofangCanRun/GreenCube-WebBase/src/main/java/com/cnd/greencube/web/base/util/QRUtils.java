...
import com.cnd.greencube.web.base.plugin.fileupload.UploadFileManager.UPLOAD_TYPE;
...
public class QRUtils {
	...
	public static TFile generateQRImage(String filename, String url) throws WriterException, IOException {
		...
		// 转存到文件服务器上
		TFile f = UploadFileManager.uploadFile(FileUtils.convert2MultiPart(tempFile));
