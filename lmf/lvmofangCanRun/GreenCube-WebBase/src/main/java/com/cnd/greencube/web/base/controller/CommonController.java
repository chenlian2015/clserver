package com.cnd.greencube.web.base.controller;
...
import com.cnd.greencube.web.base.dao.redis.JedisTemplate.JedisActionNoResult;
import com.cnd.greencube.web.base.dao.redis.RedisDaoSupportImpl;
...
import com.cnd.greencube.web.base.util.AddressUtils;
...
import com.cnd.greencube.web.base.util.myutil.RandomUtil;
...
public class CommonController extends BaseController {
	...
	private boolean isValidFrom() {
		...
		if (domainName.startsWith("192.168.") || domainName.startsWith("10.2.")) {
			return true;
		}
	...
	public String imgcut() {
		...
		if (preview != null) {
			try {
				...
				for (int i = 0; i < size; i++) {
					...
					sbOut.append("<div class=\"border1px no-pic preview-container\" style=\"width:" + obj.get("width") + "px; height:" + obj.get("height")
							+ "px\">");
					sbOut.append("     	 <img src=\"/themes/greencube/images/no_pic.jpg\" width=\"" + obj.get("width") + "\" height=\"" + obj.get("height")
			...
			sbOut.append(" <img src=\"/themes/greencube/images/no_pic.jpg\" width=\"150\" height=\"150\" alt=\"\" class=\"jcrop-preview\" data-width=\"150\" data-height=\"150\"/></div>");
	...
	public String download(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			if (!StringUtils.isEmpty(fileUrl)) {
				in = UploadFileManager.getFileInputStreamFromUrl(fileUrl);
			}
