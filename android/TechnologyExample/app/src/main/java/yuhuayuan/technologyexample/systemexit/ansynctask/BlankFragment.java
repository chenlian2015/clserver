...
import yuhuayuan.technologyexample.hunxiao.bean.TestActivity;
...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        viewRoot.findViewById(R.id.id_hide).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    void testHello()
    {
        ...
        Toast.makeText(getContext(), sharedPreferences.getString("hello", "thread world"), Toast.LENGTH_SHORT).show();
    }
    class MyRunnbaale implements Runnable
    {
        @Override
        public void run() {
            try {
    ...
    public void onResume() {
        super.onResume();
        new Thread(new MyRunnbaale()).start();
    }
